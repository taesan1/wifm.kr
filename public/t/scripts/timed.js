...
var inputParts = inputFullTime.split(":"); console.log("inputParts: "+inputParts);
var inputTime = inputParts.slice(0, -1).join(":"); console.log("inputTime: "+inputTime);// 시간 부분 (13:32:16)
var inputMs = parseInt(inputParts[inputParts.length - 1]);console.log("inputMs: "+inputMs); // 밀리초 부분 (722)
